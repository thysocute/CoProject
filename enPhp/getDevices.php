...
if (empty($du_stmt)) {
  ...
  echo     'You do not have any equipment information, please go to improve the equipment information！';
  echo   '</td>';
  echo '</tr>';
  exit();
  ...
  if (!empty($results)) {
    ...
    foreach ($results as $value) {
      ...
      echo '  <td>';
      echo '  <a href="../php/deleteDevice.php?device_id='.$value['deviceId'].'&account='.$account.'">delete</a>';
      echo '  </td>';
      echo '</tr>';
      $index++;
    }
