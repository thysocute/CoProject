              ...
              <div class="row transparent">
                <div class="transparent">
                  ...
                  <form method="POST" action="../php/handle-signup.php">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon glyphicon glyphicon-lock" aria-hidden="true"></span>
                      <input type="password" name="conpwd" class="form-control" placeholder="Confirm Password" aria-describedby="basic-addon1">
                    </div>
                    ...
                    <div class="input-group">
                      ...
                      <input type="tel" name="phone" class="form-control" placeholder="Telephone" aria-describedby="basic-addon1">
                    </div>
