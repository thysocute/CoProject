       ...
       <div class="row">
          ...
          <ul id="mainMenu" class="part-nav nav-css nav nav-tabs col-md-9">
            <?php if (isset($_SESSION["username"]) && $_SESSION["username"] != "") {
              ...
              echo '<li id="coChat"><a href="../enStatic/communication.php">Co-Management </a></li>';
              echo '<li id="coSchedule"><a href="../enStatic/calendar.php">Sch-Management</a> </li>';
              echo '<li id="coEdit"><a href="../enStatic/coEdit.php">Co-Editing</a></li>';
              ...
              echo '<li id="coVUI"><a href="../enStatic/coVUI.php">VSCT</a></li>';
        ...
        <div id="menu" class="menu">
          ...
          <ul id="mobile_menu" class="mobile-menu" >
            <?php if (isset($_SESSION["username"]) && $_SESSION["username"] != "") {
              ...
              echo '<li id="coEdit_m"><a href="../enStatic/coEdit.php">Collaborative Editing</a></li>';
              echo '<li id="coSchedule_m"><a href="../enStatic/calendar.php">Sch-Management</a> </li>';
              echo '<li id="coChat_m"><a href="../enStatic/communication.php">Communication Management </a></li>';
