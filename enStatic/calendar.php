...
<head>
	...
	<script type="text/javascript" src="../enJs/calendarFun.js"></script>
...
<div class="container">
			...
			<div class="col s12" id="lista">
                <div class="row">
                  <div class="col s12">
                    ...
                    <?php include '../enPhp/userlist.php'; ?>
                </div>
            </div>
		</div><!-- 组员 section end -->
		...
		<div class="col-xs-9 col-sm-9 col-md-10">
			...
			<div id="dialog-form" style="display:none">
				<form class="form-inline">
					<p>
						<label>Affairs Title：</label>
						<input type="text" class="form-control" id="title">
					</p>
					<p>
						<label>Affairs Content：</label>
						<textarea class="textarea" rows="4" placeholder="Content" id="description"></textarea>
					</p>
					<p>
						<label>Affairs Type：</label>
						<select class="select" id="remark">
							<option value="0" selected>Personal Affairs</option>
							<option value="1">Work Affairs</option>
						</select>
					</p>
					<p>
					...
					<p class="checkbox check">
						<label class="checkbox-inline"><input type="checkbox" id="isallday" value="0">All Day</label>
						<label class="checkbox-inline"><input type="checkbox" id="end">Ene Time</label>
			...
			<div id="search" style="display:none">
				<form class="form-inline">
					...
					<p>
						<label>Affairs Type：</label>
						<select>
							<option value="">Work Affairs</option>
							<option value="">Personal Affairs </option>
						</select>
					</p>
					<p>
						<label>Affairs Content：</label>
	...
	<div class="setRandLayout" id="setRandLayout">
		<div id="importanceRand" class="randBox">
			<div class="rHead">
				<h6>Schedule priority setting</h6>
				<!-- calendar box close -->
				<!-- <span class="icon"></span> -->
			</div>
			<div class="rBody" >
				<p class="tips">There is a time conflict, please set the priority</p>
				<div class="clearfix">
				...
				<hr/>
				<div class="footBar">
					<button id="setSubBtn" >Confirme</button>
